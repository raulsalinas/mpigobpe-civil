<div class="modal fade" id="modal-filtro_matrimonios" tabindex="-1" role="dialog" aria-labelledby="modal-filtro_matrimonios" style="top: -25px; position: absolute; left: 0px; right: 0px;">
                ...
                <div class="modal-body" style="padding: 4px">
                    <div class="card-body" style="padding: 5px;">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="tab2-tab" data-toggle="tab" href="#tab2" role="tab" aria-controls="tab2" aria-selected="false">Datos de matrimonio</a>
                            </li>
                        </ul>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>Fecha Matrimonio Desde:</label>
                                                    <div class="input-group date" data-target-input="nearest">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>Fecha Matrimonio Hasta:</label>
                                                    <div class="input-group date" data-target-input="nearest">
