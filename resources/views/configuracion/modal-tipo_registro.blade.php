<div class="modal fade" id="modal-tipo_registro" tabindex="-1" role="dialog" aria-labelledby="modal-tipo_registro">

    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <form id="formulario-tipo_registro" method="POST" autocomplete="off">
