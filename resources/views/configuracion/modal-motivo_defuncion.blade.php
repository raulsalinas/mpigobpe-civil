<div class="modal fade" id="modal-motivo_defuncion" tabindex="-1" role="dialog" aria-labelledby="modal-motivo_defuncion">

    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <form id="formulario-motivo_defuncion" method="POST" autocomplete="off">
