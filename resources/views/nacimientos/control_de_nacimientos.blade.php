...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Control de Nacimientos <span name="nombreCondicionActa">{{$tipo}}</span></h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">Inicio</li>
                    <li class="breadcrumb-item">Nacimientos <span name="nombreCondicionActa">{{$tipo}}</span></li>
...
<script src="{{ asset('js/modelo-vista/nacimientos/control_nacimiento-view.js')}}?v={{filemtime(public_path('js/modelo-vista/nacimientos/control_nacimiento-view.js'))}}"></script>
