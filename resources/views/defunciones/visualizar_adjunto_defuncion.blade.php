...
<script src="{{ asset('js/modelo-vista/defunciones/visualizar_defuncion.js')}}?v={{filemtime(public_path('js/modelo-vista/defunciones/visualizar_defuncion.js'))}}"></script>
@endsection